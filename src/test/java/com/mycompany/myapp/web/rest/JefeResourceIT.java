...
import static com.mycompany.myapp.domain.JefeAsserts.*;
...
import com.mycompany.myapp.repository.JefeRepository;
...
class JefeResourceIT {
    ...
    private static final String DEFAULT_APELLIDO_JEFE = "AAAAAAAAAA";
    private static final String UPDATED_APELLIDO_JEFE = "BBBBBBBBBB";

    private static final Integer DEFAULT_TELEFONO_JEFE = 1;
    private static final Integer UPDATED_TELEFONO_JEFE = 2;

    private static final String DEFAULT_CORREO_JEFE = "AAAAAAAAAA";
    private static final String UPDATED_CORREO_JEFE = "BBBBBBBBBB";
    ...
    public static Jefe createEntity() {
        return new Jefe()
            ...
            .apellidoJefe(DEFAULT_APELLIDO_JEFE)
            .telefonoJefe(DEFAULT_TELEFONO_JEFE)
            .correoJefe(DEFAULT_CORREO_JEFE);
    }
    ...
    public static Jefe createUpdatedEntity() {
        return new Jefe()
            ...
            .apellidoJefe(UPDATED_APELLIDO_JEFE)
            .telefonoJefe(UPDATED_TELEFONO_JEFE)
            .correoJefe(UPDATED_CORREO_JEFE);
    }
    ...
    void getAllJefes() throws Exception {
        ...
        restJefeMockMvc
            ...
            .andExpect(jsonPath("$.[*].apellidoJefe").value(hasItem(DEFAULT_APELLIDO_JEFE)))
            .andExpect(jsonPath("$.[*].telefonoJefe").value(hasItem(DEFAULT_TELEFONO_JEFE)))
            .andExpect(jsonPath("$.[*].correoJefe").value(hasItem(DEFAULT_CORREO_JEFE)));
    }
    ...
    void getJefe() throws Exception {
        ...
        restJefeMockMvc
            ...
            .andExpect(jsonPath("$.apellidoJefe").value(DEFAULT_APELLIDO_JEFE))
            .andExpect(jsonPath("$.telefonoJefe").value(DEFAULT_TELEFONO_JEFE))
            .andExpect(jsonPath("$.correoJefe").value(DEFAULT_CORREO_JEFE));
    }
    ...
    void partialUpdateJefeWithPatch() throws Exception {
        ...
        partialUpdatedJefe.apellidoJefe(UPDATED_APELLIDO_JEFE).correoJefe(UPDATED_CORREO_JEFE);
