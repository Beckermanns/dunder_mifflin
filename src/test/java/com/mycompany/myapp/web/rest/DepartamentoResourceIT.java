...
import static com.mycompany.myapp.domain.DepartamentoAsserts.*;
...
class DepartamentoResourceIT {
    ...
    private static final Float DEFAULT_PRESUPUESTO_DEPARTAMENTO = 1F;
    private static final Float UPDATED_PRESUPUESTO_DEPARTAMENTO = 2F;
    ...
    void partialUpdateDepartamentoWithPatch() throws Exception {
        ...
        partialUpdatedDepartamento.presupuestoDepartamento(UPDATED_PRESUPUESTO_DEPARTAMENTO);
