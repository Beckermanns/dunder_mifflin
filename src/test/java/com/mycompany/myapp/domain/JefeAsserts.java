...
public class JefeAsserts {
    ...
    public static void assertJefeUpdatableFieldsEquals(Jefe expected, Jefe actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getApellidoJefe()).as("check apellidoJefe").isEqualTo(actual.getApellidoJefe()))
            .satisfies(e -> assertThat(e.getTelefonoJefe()).as("check telefonoJefe").isEqualTo(actual.getTelefonoJefe()))
            .satisfies(e -> assertThat(e.getCorreoJefe()).as("check correoJefe").isEqualTo(actual.getCorreoJefe()));
    }
