...
public class DepartamentoTestSamples {
    ...
    public static Departamento getDepartamentoSample1() {
        return new Departamento().id(1L).nombreDepartamento("nombreDepartamento1").ubicacionDepartamento("ubicacionDepartamento1");
    }

    public static Departamento getDepartamentoSample2() {
        return new Departamento().id(2L).nombreDepartamento("nombreDepartamento2").ubicacionDepartamento("ubicacionDepartamento2");
    }
