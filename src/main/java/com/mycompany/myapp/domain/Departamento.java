...
public class Departamento implements Serializable {
    ...
    private Float presupuestoDepartamento;
    ...
    public Float getPresupuestoDepartamento() {
        return this.presupuestoDepartamento;
    }

    public Departamento presupuestoDepartamento(Float presupuestoDepartamento) {
        this.setPresupuestoDepartamento(presupuestoDepartamento);
        return this;
    }

    public void setPresupuestoDepartamento(Float presupuestoDepartamento) {
