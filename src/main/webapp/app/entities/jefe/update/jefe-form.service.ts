...
type JefeFormGroupContent = {
  ...
  apellidoJefe: FormControl<IJefe['apellidoJefe']>;
  telefonoJefe: FormControl<IJefe['telefonoJefe']>;
  correoJefe: FormControl<IJefe['correoJefe']>;
};
...
export class JefeFormService {
  createJefeFormGroup(jefe: JefeFormGroupInput = { id: null }): JefeFormGroup {
    ...
    return new FormGroup<JefeFormGroupContent>({
      ...
      apellidoJefe: new FormControl(jefeRawValue.apellidoJefe),
      telefonoJefe: new FormControl(jefeRawValue.telefonoJefe),
      correoJefe: new FormControl(jefeRawValue.correoJefe),
    });
  }
